...
def train_model(
    ...
    #calculate sen,spe
    # valtest_sen, valtest_spe = 
    
    matrix = confusion_matrix(labels_all[idx_all['valtest']], valtest_preds)
    ...
    logging.log(22, f"{valtest_name} accuracy: {valtest_acc * 100:.2f}%, sen:{sen * 100:.2f}%, spe:{spe * 100:.2f}%")
    ...
    result['specifity'] = spe

    return model, result, valtest_acc, sen, spe
